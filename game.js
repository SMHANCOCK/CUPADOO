...
import { MAX_PLAYERS, MIN_PLAYERS, MAX_DICE, START_DICE, DICE_SIDES, DEFAULT_COLORS } from './config.js';
...
// ===== RTDB sync =====
function syncState(){ try{ if(stateRef) stateRef.set(state); }catch(e){ error('syncState failed', e); } }
function syncAll(){
