...
function renderControls(){
  ...
  // If turnIndex isn't in yet, keep buttons enabled; host will validate.
...
function processInput(a){
  ...
  // SPECIAL CASE: first bid of a round when turnIndex hasn't been published yet
